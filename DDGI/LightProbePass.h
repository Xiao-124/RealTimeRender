...
private:
	...
	std::shared_ptr<ElayGraphics::STexture> TextureSamplePosition;
	std::shared_ptr<ElayGraphics::STexture> TextureSampleAlbedo; 
	std::shared_ptr<ElayGraphics::STexture> TextureSampleNormal; 
	std::shared_ptr<ElayGraphics::STexture> TextureSampleChebyshev;
