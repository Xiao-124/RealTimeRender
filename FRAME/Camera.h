...
#include <GL/glew.h>
#include <GLM/glm.hpp>
#include <GLM/gtc/matrix_transform.hpp>Point2fT
...
public:
	...
	glm::mat4 getModelTransformMatrix() { return modelMatrix; }
	...
	void setFocalPosition(glm::dvec3 focal) { m_FocalPoint = focal; }
private:
