...
glm::mat4 ElayGraphics::Camera::getMainCameraModelMatrix()
{
	return CResourceManager::getOrCreateInstance()->fecthOrCreateMainCamera()->getModelTransformMatrix();
...
void ElayGraphics::Camera::setMainCameraFocalPos(glm::dvec3 vFocalPos)
{
	return CResourceManager::getOrCreateInstance()->fecthOrCreateMainCamera()->setFocalPosition(vFocalPos);
}
